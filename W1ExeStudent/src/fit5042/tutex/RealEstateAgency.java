...
public class RealEstateAgency {
    ...
    // complete this method
    public Property searchPropertyById(int i) throws Exception {
    	Property property=propertyRepository.searchPropertyById(i);
    	return property;
    ...
    public void run() throws Exception {
        ...
        Property property= searchPropertyById(i);
        if (property!= null)
        {
        ...
        {
        	System.out.println("No such property ID exist in database");
        }
